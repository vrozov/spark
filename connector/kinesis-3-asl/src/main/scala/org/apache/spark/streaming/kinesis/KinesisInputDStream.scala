...
private[kinesis] class KinesisInputDStream[T: ClassTag](
    ...
    val dynamoDBCreds: Option[SparkAwsCredentials] = None,
    val cloudWatchCreds: Option[SparkAwsCredentials] = None,
    val metricsLevel: Option[MetricsLevel] = None,
    val metricsEnabledDimensions: Option[Set[String]] = None,
